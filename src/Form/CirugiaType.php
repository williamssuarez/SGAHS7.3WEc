    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('procedimientoPropuesto', TextType::class, [
                ...
                'constraints' => [
                    new NotBlank(message: 'Debe ingresar un procedimiento propuesto'),
                ]
            ])
            ->add('fechaPrograma', DateTimeType::class, [
                'widget' => 'single_text',
            ...
            ->add('quirofano', EntityType::class, [
                ...
                'choice_label' => 'nombre',
                'attr' => ['class' => 'srchSelect'],
            ])
            ->add('medicoCirujano', EntityType::class, [
                'class' => User::class,
                'choice_label' => 'email',
                'attr' => ['class' => 'srchSelect'],
            ])
